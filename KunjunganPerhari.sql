SELECT DATE(k.MASUK) TANGGGAL
     , SUM(CASE WHEN r.JENIS_KUNJUNGAN = 2 THEN 1 ELSE 0 END) RAWATDARURAT
...
JOIN master.ruangan r ON r.ID=k.RUANGAN AND r.JENIS_KUNJUNGAN IN(1,2,3)
